...
python generate_wenet_data.py --utts=${train_utts} --utt2tones=${utt2tones} --output-dir=${output_dir}/train || exit 1
python generate_wenet_data.py --utts=${test_utts} --utt2tones=${utt2tones} --output-dir=${output_dir}/test || exit 1
